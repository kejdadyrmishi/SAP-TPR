  ...
  METHOD post_doc.
    ...
    LOOP AT mt_alv_data ASSIGNING FIELD-SYMBOL(<ls_data>)
      ...
      LOOP AT GROUP <lg_prog_nr> ASSIGNING FIELD-SYMBOL(<ls_alv_data>).
        ...
        <ls_bapi_accr>-exch_rate  = abs( COND #( WHEN <ls_alv_data>-dmbtr IS INITIAL THEN 1 ELSE <ls_bapi_accr>-amt_doccur / <ls_alv_data>-dmbtr ) ).
        ...
        (
         ...
         exch_rate  = abs( COND #( WHEN <ls_alv_data>-dmbtr IS INITIAL THEN 1 ELSE <ls_bapi_accr>-amt_doccur / <ls_alv_data>-dmbtr ) )
         )
         ( itemno_acc = 2
         curr_type  = '00'
         currency   = <ls_alv_data>-waers
